...
- Pada superclass `Fasilitas` terdapat:
  ...
  <img width="800" height="238" alt="image" src="https://github.com/user-attachments/assets/f25092ae-32fe-4477-9c0e-338c45a368e2" />

- Kemudian method tersebut di-override pada `FasilitasUmum`:

  <img width="800" height="202" alt="image" src="https://github.com/user-attachments/assets/e81b4402-2056-4c24-bc54-3537c9bccda2" />

- dan pada `FasilitasOlahraga`:

  <img width="800" height="194" alt="image" src="https://github.com/user-attachments/assets/48e5e13f-9fa6-4768-b4d9-a527aecce8e3" />
